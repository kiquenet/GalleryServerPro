...
namespace GalleryServerPro.Business
{
	...
	/// </summary>
	public class UiTemplateCollection : Collection<IUiTemplate>, IUiTemplateCollection
	{
		/// <overloads>
		...
		/// Initializes a new instance of the <see cref="IUiTemplateCollection"/> class.
		/// </summary>
		public UiTemplateCollection() : base(new List<IUiTemplate>())
		{
		}
		...
		/// </summary>
		public UiTemplateCollection(IEnumerable<IUiTemplate> items) : base(new List<IUiTemplate>(items))
		{
		}
		...
		public IUiTemplate Get(UiTemplateType templateType, IAlbum album)
		{
			...
			var tmplItems = (from t in Items where t.TemplateType == templateType select t).ToList();
