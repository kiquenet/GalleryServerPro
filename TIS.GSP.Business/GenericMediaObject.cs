...
namespace GalleryServerPro.Business
{
	...
	public class GenericMediaObject : GalleryObject
	{
		...
		/// <exception cref="GalleryServerPro.Events.CustomExceptions.InvalidMediaObjectException">Thrown when the  
		...
		internal GenericMediaObject(FileInfo file, IAlbum parentAlbum)
			: this(int.MinValue, parentAlbum, string.Empty,
						 ...
						 String.Empty, DateTime.Now, String.Empty, DateTime.MinValue, parentAlbum != null ? parentAlbum.IsPrivate : false, false, file, null)
		{
		}
