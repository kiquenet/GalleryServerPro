...
namespace GalleryServerPro.Business
{
  ...
  public class GalleryControlSettings : IGalleryControlSettings
  {
    ...
    /// automatically set to <see cref="GalleryServerPro.Business.ViewMode.Single" />. Only one of these properties should be set: 
    ...
    /// <see cref="GalleryServerPro.Business.ViewMode.Multiple" />. When the value is <see cref="GalleryServerPro.Business.ViewMode.Multiple" />,
    /// the contents of an album are shown as a set of thumbnail images. When set to <see cref="GalleryServerPro.Business.ViewMode.Single" />, 
    /// a single media object is displayed. When set to <see cref="GalleryServerPro.Business.ViewMode.SingleRandom" />, a single media object 
    /// is displayed that is randomly selected. When a <see cref="IGalleryControlSettings.MediaObjectId" /> is specified, the 
    /// <see cref="IGalleryControlSettings.ViewMode" /> is automatically set to <see cref="GalleryServerPro.Business.ViewMode.Single" />.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the toolbar is rendered above individual media objects.
    /// </summary>
    /// <value>
    ...
    public bool? ShowMediaObjectIndexPosition { get; set; }
		...
		/// <summary>
		/// Gets or sets a value indicating whether the download links/embed button is visible above a media object. If not specified, the 
		...
		/// </summary>
		/// <value><c>true</c> if the download links/embed button is visible above a media object; otherwise, <c>false</c>.</value>
    ...
    public bool? AutoPlaySlideShow { get; set; }
		...
		/// <summary>
		/// Gets or sets the type of the slide show. The default value is <see cref="GalleryServerPro.Business.SlideShowType.FullScreen" />.
		/// </summary>
