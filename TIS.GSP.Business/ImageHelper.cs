...
namespace GalleryServerPro.Business
{
	...
	public static class ImageHelper
	{
		...
		/// <exception cref="GalleryServerPro.Events.CustomExceptions.UnsupportedImageTypeException">Thrown when <paramref name="sourceBmp" />
		...
		/// <exception cref="GalleryServerPro.Events.CustomExceptions.UnsupportedImageTypeException">Thrown when <paramref name="inputBmp"/> 
