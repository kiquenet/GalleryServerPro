...
namespace GalleryServerPro.Business
{
	...
	public class ImageOptimizedCreator : DisplayObjectCreator
	{
		...
		public override void GenerateAndSaveFile()
		{
			...
			{
				bool rotateIsRequested = (GalleryObject.Rotation != MediaObjectRotation.NotSpecified);

				if (rotateIsRequested || ((GalleryObject.IsNew) && (String.IsNullOrEmpty(GalleryObject.Optimized.FileName))))
				{
		...
		private bool IsOptimizedImageRequired()
		{
			...
			bool rotateIsRequested = (GalleryObject.Rotation != MediaObjectRotation.NotSpecified); // Test 3
