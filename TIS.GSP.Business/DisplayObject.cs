...
namespace GalleryServerPro.Business
{
	...
	public class DisplayObject : IDisplayObject
	{
		...
		/// <exception cref="GalleryServerPro.Events.CustomExceptions.InvalidMediaObjectException">Thrown if the file 
			...
			set
			{
				...
				if (value != null)
				{
					...
					if (parentAlbum != null)
					{
						...
						{
							throw new GalleryServerPro.Events.CustomExceptions.InvalidMediaObjectException(String.Format(CultureInfo.CurrentCulture, Resources.DisplayObject_FileInfo_Ex_Msg, value.Name, parentAlbum.Id, albumOriginalPath, albumOptimizedPath, albumThumbnailPath));
						}
					}
				}
				else
