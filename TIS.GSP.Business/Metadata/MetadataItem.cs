...
namespace GalleryServerPro.Business.Metadata
{
	...
	public class MetadataItem
	{
		...
		private void ExtractPropertyItemValue()
		{
			...
			{
				throw new GalleryServerPro.Events.CustomExceptions.BusinessException("The function GalleryServerPro.Business.Metadata.MetadataItem.ExtractPropertyItemValue() must assign a value other than NotDefined to the field _extractedValueType.");
			}
		}
