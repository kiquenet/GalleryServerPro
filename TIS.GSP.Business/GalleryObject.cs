...
namespace GalleryServerPro.Business
{
	...
	public abstract class GalleryObject : IGalleryObject, IComparable
	{
		...
		private MediaObjectRotation _rotation;
		...
		/// <summary>
		/// Gets or sets the amount of rotation to be applied to this gallery object when it is saved. Applies only to <see cref="Image" />
		...
		public MediaObjectRotation Rotation
		{
			get
			{
		...
		/// </summary>
		/// <returns>An instance of <see cref="MediaObjectRotation" />.</returns>
		public MediaObjectRotation CalculateNeededRotation()
		{
			var fileRotation = GetOrientation(); // Actual rotation of the original file, as discovered via orientation metadata
			var userRotation = Rotation; // Desired rotation by the user

			if (userRotation == MediaObjectRotation.NotSpecified)
			{
				userRotation = MediaObjectRotation.Rotate0;
			}
			...
			switch (fileRotation)
			{
				...
				case Orientation.Rotated90:
					switch (userRotation)
					{
						case MediaObjectRotation.Rotate0: return MediaObjectRotation.Rotate270;
						case MediaObjectRotation.Rotate90: return MediaObjectRotation.Rotate0;
				...
				case Orientation.Rotated180:
					switch (userRotation)
					{
						case MediaObjectRotation.Rotate0: return MediaObjectRotation.Rotate180;
						case MediaObjectRotation.Rotate90: return MediaObjectRotation.Rotate270;
						case MediaObjectRotation.Rotate180: return MediaObjectRotation.Rotate0;
				...
				case Orientation.Rotated270:
					switch (userRotation)
					{
						case MediaObjectRotation.Rotate0: return MediaObjectRotation.Rotate90;
						case MediaObjectRotation.Rotate90: return MediaObjectRotation.Rotate180;
						case MediaObjectRotation.Rotate180: return MediaObjectRotation.Rotate270;
						case MediaObjectRotation.Rotate270: return MediaObjectRotation.Rotate0;
					}
					break;
			}

			return MediaObjectRotation.NotSpecified;
		}
