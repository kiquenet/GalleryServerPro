    ...
    public string ImagePath
    {
      ...
      set
      {
        ...
        else
        {
          ...
          {
            throw new FileNotFoundException(String.Format(CultureInfo.CurrentCulture, "No image file exists at {0} or {1}. Check the watermark settings and verify a valid file exists in the specified location.", value, fullPath));
          }
