...
namespace GalleryServerPro.Business
{
	...
	{
		/// <summary>
		/// A System.Collections.Concurrent.ConcurrentDictionary&lt;<see cref="string" />, <see cref="GalleryServerPro.Business.Interfaces.IGalleryServerRoleCollection" />&gt;
		...
		Users,
		/// <summary>
		/// A System.Collections.Concurrent.ConcurrentDictionary&lt;<see cref="string" />, <see cref="GalleryServerPro.Business.Interfaces.IUserAccountCollection" />&gt;
		...
		/// <summary>
		/// A System.Collections.Concurrent.ConcurrentDictionary&lt;<see cref="int" />, <see cref="GalleryServerPro.Business.Interfaces.IAlbum" />&gt; 
		/// stored in cache. The key specifies the ID of the album stored in the dictionary entry.
		/// </summary>
		Albums,
		/// <summary>
		/// A System.Collections.Concurrent.ConcurrentDictionary&lt;<see cref="int" />, <see cref="GalleryServerPro.Business.Interfaces.IGalleryObject" />&gt; 
		/// stored in cache. The key specifies the ID of the media object stored in the dictionary entry.
		/// </summary>
		MediaObjects,
		/// <summary>
		/// An <see cref="GalleryServerPro.Business.Interfaces.IEventCollection" /> stored in cache.
		/// </summary>
		AppEvents,
		/// <summary>
		/// A System.Collections.Concurrent.ConcurrentDictionary&lt;<see cref="string" />, <see cref="GalleryServerPro.Business.Interfaces.IUserProfile" />&gt; 
		/// stored in cache. The key specifies the username of the profile stored in the dictionary entry.
		/// </summary>
		Profiles,
		/// <summary>
		/// An <see cref="GalleryServerPro.Business.Interfaces.IUiTemplateCollection" /> stored in cache.
		/// </summary>
		UiTemplates,
		/// <summary>
		/// An <see cref="GalleryServerPro.Business.Interfaces.IMediaTemplateCollection" /> stored in cache.
		/// </summary>
		MediaTemplates,
		/// <summary>
		/// A System.Collections.Concurrent.ConcurrentDictionary&lt;<see cref="int" />, <see cref="GalleryServerPro.Business.Interfaces.IMimeTypeCollection" />&gt; 
