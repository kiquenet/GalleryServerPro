  ...
  public abstract class UploadHandlerBase : IHttpHandler
  {
    ...
    public void ProcessRequest(HttpContext context)
    {
      ...
      if (Request.Files.Count > 0)
      {
        ...
        var validateExtension = !AllowedExtensions.Equals(".*"); // don't validate when it's a wildcard
        ...
        if (validateExtension)
        {
          ...
          {
            WriteErrorResponse(Resources.GalleryServerPro.Task_Add_Objects_InvalidFileExtensionUploaded);
            return;
          }
        }
        ...
        if (chunks == -1)
        {
          ...
          {
            WriteErrorResponse(String.Format(CultureInfo.InvariantCulture, Resources.GalleryServerPro.Task_Add_Objects_UploadedFileIsTooLarge, MaxUploadSize, Request.ContentLength), 413);
            return;
          }
