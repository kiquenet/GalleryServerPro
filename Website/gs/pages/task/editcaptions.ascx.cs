...
namespace GalleryServerPro.Web.Pages.Task
{
	...
	public partial class editcaptions : Pages.TaskPage
	{
		...
		private void ConfigureControls()
		{
			...
			var albumChildren = this.GetAlbum().GetChildGalleryObjects(GalleryObjectType.MediaObject).ToSortedList();
			...
			{
				this.RedirectToAlbumViewPage("msg={0}", ((int)MessageType.CannotEditCaptionsNoEditableObjectsExistInAlbum).ToString(CultureInfo.InvariantCulture));
			}
		}
