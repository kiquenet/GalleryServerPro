...
namespace GalleryServerPro.Web.Pages.Task
{
	...
	public partial class assignthumbnail : Pages.TaskPage
	{
		...
		protected void Page_Load(object sender, EventArgs e)
		{
			...
			if ((this.GetAlbum() != null) && (!this.GetAlbum().GetChildGalleryObjects(GalleryObjectType.All).Any()))
			{
				this.RedirectToAlbumViewPage("msg={0}", ((int)MessageType.CannotAssignThumbnailNoObjectsExistInAlbum).ToString(CultureInfo.InvariantCulture));
			}
		...
		protected override bool OnBubbleEvent(object source, EventArgs args)
		{
			...
			if ((btn != null) && (((btn.ID == "btnOkTop") || (btn.ID == "btnOkBottom"))))
			{
				...
				this.RedirectToAlbumViewPage("msg={0}", ((int)MessageType.ThumbnailSuccessfullyAssigned).ToString(CultureInfo.InvariantCulture));
			}
		...
		private void ConfigureControls()
		{
			...
			var albumChildren = this.GetAlbum().GetChildGalleryObjects(GalleryObjectType.All).ToSortedList();
