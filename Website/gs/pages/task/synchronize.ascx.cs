...
namespace GalleryServerPro.Web.Pages.Task
{
  ...
  public partial class synchronize : Pages.TaskPage
  {
    ...
    protected string SyncCompleteJsRenderTemplate
    {
      get
      {
        string taskSynchProgressSkippedObjectsMaxExceededMsg = String.Format(CultureInfo.CurrentCulture, Resources.GalleryServerPro.Task_Synch_Progress_Skipped_Objects_Max_Exceeded_Msg, GlobalConstants.MaxNumberOfSkippedObjectsToDisplayAfterSynch);
  ...
  {{{{/if}}}}
",
 Resources.GalleryServerPro.Task_Synch_Progress_Successful, // 0
 GlobalConstants.MaxNumberOfSkippedObjectsToDisplayAfterSynch, // 1
 taskSynchProgressSkippedObjectsMaxExceededMsg, // 2
 Resources.GalleryServerPro.Task_Synch_Progress_Skipped_Objects_Msg1, // 3
 Resources.GalleryServerPro.Task_Synch_Progress_Skipped_Objects_Msg2 // 4
 );
      }
    }
