<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="manageroles.ascx.cs" Inherits="GalleryServerPro.Web.Pages.Admin.manageroles" %>
    ...
    <section id="gsp_optionsDtl" class="gsp_optionsDtl ui-corner-bottom">
      <section>
        <p>
          ...
          <label for="gsp_showCheckboxes">
            <asp:Literal ID="l3" runat="server" Text="<%$ Resources:GalleryServerPro, Site_Show_Checkboxes_Lbl %>" />
          </label>
        </p>
        <section class="gsp_checkboxOptions">
          <p>
            <a id="gsp_chkCheckUncheckAll" data-ischecked="false" class="gsp_disabled">
              <asp:Literal ID="l4" runat="server" Text="<%$ Resources:GalleryServerPro, Site_ToggleCheckAll_Lbl %>" />
            </a>
          </p>
          <p runat="server">
            <a id="gsp_chkDeleteRoles" class="gsp_disabled">
              <asp:Literal ID="l5" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Manage_Roles_Delete_Selected_Roles_Lbl %>" />
      ...
      <p>
        ...
        <label for="gsp_ShowOwnerRoles">
          <asp:Literal ID="l6" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_Manage_Roles_Show_Owner_Roles_Lbl %>" />
        </label>
      </p>
    </section>
  ...
  <script>
    (function ($) {
      ...
      var configControls = function() {
        ...
        var gspRoles = $.parseJSON('<%= GetRoleNames() %>');
            ...
            if ($(this).prop("checked")) {
              ...
              $("#gsp_chkDeleteRoles").click(function (e) {
                ...
                var ajaxArray = $.map(rolesToDelete, function(roleName, idx) {
                  return $.ajax({
                    type: "DELETE",
                    url: window.Gsp.AppRoot + '/api/roles/deletebyrolename?roleName=' + encodeURI(roleName),
                    error: function(response) {
                      $.gspShowMsg("Role '" + roleName + "' not deleted", response.responseText, { msgType: 'error', autoCloseDelay: 0 });
                ...
                $.when.apply($, ajaxArray).then(function() {
                  ...
                  $.gspShowMsg("Roles Deleted", "The roles were successfully deleted.", { msgType: 'success' });
                  onRolesDeleted();
        ...
        var bindRoleDataReceived = function (data, roleHeader, roleContent) {
          ...
          var saveRoleData = function (e) {
            ...
            var onRoleSaved = function (response) {
              $.gspShowMsg("Save Successful", response, { msgType: 'success' });
            ...
            try {
              ...
              $.ajax(({
                type: "POST",
                url: window.Gsp.AppRoot + '/api/roles/',
          ...
          var roleDeleteClick = function (e) {
            var deleteRole = function (role) {
              ...
              var onRoleDeleted = function (response) {
                $.gspShowMsg("Role Deleted", response, { msgType: 'success' });
              ...
              $.ajax(({
                type: "DELETE",
                url: window.Gsp.AppRoot + '/api/roles/deletebyrolename?roleName=' + encodeURI(role.Name),
                success: function(response) {
            ...
            if (confirm("<%= Resources.GalleryServerPro.Admin_Manage_Roles_Confirm_Delete_Text %> '" + gspRoleData.Name + "'?")) {
          ...
          $("input", roleHeader).prop('disabled', true).attr('title', 'Disabled - Enter a product key to restore functionality');
        };
      ...
      var configTooltips = function () {
        $('.gsp_admin_h2_txt', '#<%= cid %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_Overview_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_Overview_Bdy.JsEncode() %>'
        });
        
        $('#gsp_ShowOwnerRoles').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_ShowOwnerRoles_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_ShowOwnerRoles_Bdy.JsEncode() %>'
        });
      ...
      var bindRolePermissionTooltips = function () {
        ...
        $(permSelector.format('AdministerSite'), $permContainer).gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_AdminSite_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_AdminSite_Bdy.JsEncode() %>'
        });
        
        $(permSelector.format('AdministerGallery'), $permContainer).gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_AdminGallery_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_AdminGallery_Bdy.JsEncode() %>'
        });
        
        $(permSelector.format('ViewAlbumOrMediaObject'), $permContainer).gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_ViewObject_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_ViewObject_Bdy.JsEncode() %>'
        });
        
        $(permSelector.format('ViewOriginalMediaObject'), $permContainer).gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_ViewHiResImage_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_ViewHiResImage_Bdy.JsEncode() %>'
        });
        
        $(permSelector.format('AddChildAlbum'), $permContainer).gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_AddAlbum_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_AddAlbum_Bdy.JsEncode() %>'
        });
        
        $(permSelector.format('AddMediaObject'), $permContainer).gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_AddMediaObject_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_AddMediaObject_Bdy.JsEncode() %>'
        });
        
        $(permSelector.format('EditAlbum'), $permContainer).gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_EditAlbum_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_EditAlbum_Bdy.JsEncode() %>'
        });
        
        $(permSelector.format('EditMediaObject'), $permContainer).gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_EditMediaObject_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_EditMediaObject_Bdy.JsEncode() %>'
        });
        
        $(permSelector.format('DeleteChildAlbum'), $permContainer).gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_DeleteChildAlbum_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_DeleteChildAlbum_Bdy.JsEncode() %>'
        });
        
        $(permSelector.format('DeleteMediaObject'), $permContainer).gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_DeleteMediaObject_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_DeleteMediaObject_Bdy.JsEncode() %>'
        });
        
        $(permSelector.format('Synchronize'), $permContainer).gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_Synchronize_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_Synchronize_Bdy.JsEncode() %>'
        });
        
        $(permSelector.format('HideWatermark'), $permContainer).gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_HideWatermark_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_Manage_Roles_HideWatermark_Bdy.JsEncode() %>'
        });
      };
