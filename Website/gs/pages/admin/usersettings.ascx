<%@ Control Language="C#" AutoEventWireup="True" CodeBehind="usersettings.ascx.cs" Inherits="GalleryServerPro.Web.Pages.Admin.usersettings" %>
  ...
  <div class="gsp_addleftpadding5">
    <div class="gsp_single_tab">
      ...
      <div class="gsp_single_tab_bdy gsp_dropshadow3">
        <p>
          <asp:CheckBox ID="chkEnableSelfRegistration" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_User_Settings_EnableSelfRegistration_Lbl %>" /></p>
    ...
    <div class="gsp_single_tab">
      ...
      <div class="gsp_single_tab_bdy gsp_dropshadow3">
        ...
        <p class="gsp_addtopmargin10">
          <asp:CheckBox ID="chkAllowAnonymousBrowsing" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_User_Settings_AllowAnonymousBrowsing_Label %>" />
        </p>
        <p>
          <asp:CheckBox ID="chkAllowAnonymousRating" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_User_Settings_AllowAnonymousRating_Label %>" />
        </p>
        <p>
          <asp:CheckBox ID="chkAllowHtml" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_User_Settings_AllowHtml_Label %>" />
        </p>
        <div class="gsp_addleftmargin10">
    ...
    <div class="gsp_single_tab">
      ...
      <div class="gsp_single_tab_bdy gsp_dropshadow3">
        <p>
          <asp:CheckBox ID="chkEnableUserAlbums" runat="server" Text="<%$ Resources:GalleryServerPro, Admin_User_Settings_EnableUserAlbums_Lbl %>" /></p>
        <div class="gsp_addleftmargin10">
          ...
          <asp:Panel ID="pnlOrphanUserAlbums" runat="server" Width="575" CssClass="gsp_p_a_us_oac gsp_rounded10"
            ...
            <div class="gsp_p_a_us_t">
              <input id="gsp_orphan_ua_sa" type="checkbox" /> <label for="gsp_orphan_ua_sa"><asp:Literal Text="<%$ Resources: GalleryServerPro, Admin_User_Settings_Orphan_User_Albums_Select_All_Lbl %>" runat="server" /></label>
            </div>
    ...
    <tis:wwDataBinder ID="wwDataBinder" runat="server" OnBeforeUnbindControl="wwDataBinder_BeforeUnbindControl" OnValidateControl="wwDataBinder_ValidateControl">
      <DataBindingItems>
        ...
        <tis:wwDataBindingItem ID="wbi11" runat="server" BindingSource="GallerySettingsUpdateable"
          ...
          BindingProperty="Checked" UserFieldName="<%$ Resources:GalleryServerPro, Admin_User_Settings_AllowAnonymousBrowsing_Label %>" />
        <tis:wwDataBindingItem ID="wbi12" runat="server" BindingSource="GallerySettingsUpdateable"
          ...
          BindingProperty="Checked" UserFieldName="<%$ Resources:GalleryServerPro, Admin_User_Settings_AllowAnonymousRating_Label %>" />
  ...
  <script>
    (function ($) {
      ...
      var configControls = function() {
        ...
        $('.gsp_p_a_us_doa_hl', <%= cid %>.p()).click(function() {
          var $self = $(this);
          
          var elsToDelete = $('#gsp_chk_container :input:checked');
          
          if (elsToDelete.length == 0) {
            $.gspShowMsg("Action Aborted", "No albums were marked for deletion", { msgType: 'info' });
            return false;
          } 
          else
          ...
          elsToDelete.each(function () {
            ...
            $.ajax({
              type: "DELETE",
              url: window.Gsp.AppRoot + '/api/albums/' + albumId,
              error: function (response) {
                $.gspShowMsg("Action Aborted", response.responseText, { msgType: 'error', autoCloseDelay: 0 });
              }
            }).then(function() {
              $self.removeClass('gsp_wait');
              $.gspShowMsg("Success", "The albums were successfully deleted.", { msgType: 'success' });
      ...
      var updateUi = function () {
        ...
        if (chkRequireEmailValidation.prop('disabled'))
      ...
      var configTooltips = function() {
        $('#<%= chkEnableSelfRegistration.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_enableSelfRegistration_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_enableSelfRegistration_Bdy.JsEncode() %>'
        });
        
        $('#<%= chkRequireAdminApproval.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_requireApprovalForSelfRegisteredUser_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_requireApprovalForSelfRegisteredUser_Bdy.JsEncode() %>'
        });
        
        $('#<%= chkRequireEmailValidation.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_requireEmailValidationForSelfRegisteredUser_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_requireEmailValidationForSelfRegisteredUser_Bdy.JsEncode() %>'
        });
        
        $('#<%= chkUseEmailForAccountName.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_useEmailForAccountName_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_useEmailForAccountName_Bdy.JsEncode() %>'
        });
        
        $('#<%= lblUserRoles.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_defaultRolesForSelfRegisteredUser_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_defaultRolesForSelfRegisteredUser_Bdy.JsEncode() %>'
        });
        
        $('#<%= chkEnableUserAlbums.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_enableUserAlbum_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_enableUserAlbum_Bdy.JsEncode() %>'
        });
        
        $('#<%= lblAlbumNameTemplate.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_userAlbumNameTemplate_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_userAlbumNameTemplate_Bdy.JsEncode() %>'
        });
        
        $('#<%= lblAlbumSummaryTemplate.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_userAlbumSummaryTemplate_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_userAlbumSummaryTemplate_Bdy.JsEncode() %>'
        });
        
        $('#<%= chkEnableUserAlbumDefaultForUser.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_enableUserAlbumDefaultForUser_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_enableUserAlbumDefaultForUser_Bdy.JsEncode() %>'
        });
        
        $('#<%= chkRedirectAfterLogin.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_redirectToUserAlbumAfterLogin_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_redirectToUserAlbumAfterLogin_Bdy.JsEncode() %>'
        });
        
        $('#<%= lblUserAlbumParent.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_userAlbumParentAlbumId_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_userAlbumParentAlbumId_Bdy.JsEncode() %>'
        });
        
        $('#<%= lblUserAlbumsExistingAccounts.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_User_Settings_User_Album_Existing_Accounts_Lbl_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_User_Settings_User_Album_Existing_Accounts_Lbl_Bdy.JsEncode() %>'
        });
        
        $('#<%= lblEnableUserAlbums.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_User_Settings_Turn_On_User_Album_Lbl_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_User_Settings_Turn_On_User_Album_Lbl_Bdy.JsEncode() %>'
        });
        
        $('#<%= lblDisableUserAlbums.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Admin_User_Settings_Turn_Off_User_Album_Lbl_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Admin_User_Settings_Turn_Off_User_Album_Lbl_Bdy.JsEncode() %>'
        });
        
        $('#<%= lblUsersToNotify.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_usersToNotifyWhenAccountIsCreated_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_usersToNotifyWhenAccountIsCreated_Bdy.JsEncode() %>'
        });
        
        $('#<%= chkAllowAnonymousBrowsing.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_allowAnonymousBrowsing_Hdr.JsEncode() %>', 
          content: '<%= Resources.GalleryServerPro.Cfg_allowAnonymousBrowsing_Bdy.JsEncode() %>'
        });

        $('#<%= chkAllowAnonymousRating.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_allowAnonymousRating_Hdr.JsEncode() %>', 
          content: '<%= Resources.GalleryServerPro.Cfg_allowAnonymousRating_Bdy.JsEncode() %>'
        });

        $('#<%= chkAllowHtml.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_allowUserEnteredHtml_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_allowUserEnteredHtml_Bdy.JsEncode() %>'
        });
        
        $('#<%= lblAllowedHtmlTags.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_allowedHtmlTags_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_allowedHtmlTags_Bdy.JsEncode() %>'
        });
        
        $('#<%= lblAllowedHtmlAttributes.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_allowedHtmlAttributes_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_allowedHtmlAttributes_Bdy.JsEncode() %>'
        });
        
        $('#<%= chkAllowJavascript.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_allowUserEnteredJavascript_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_allowUserEnteredJavascript_Bdy.JsEncode() %>'
        });
        
        $('#<%= chkAllowCopyingReadOnlyObjects.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_allowCopyingReadOnlyObjects_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_allowCopyingReadOnlyObjects_Bdy.JsEncode() %>'
        });
        
        $('#<%= chkAllowManageAccount.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_allowManageOwnAccount_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_allowManageOwnAccount_Bdy.JsEncode() %>'
        });
        
        $('#<%= chkAllowDeleteOwnAccount.ClientID %>').gspTooltip({
          title: '<%= Resources.GalleryServerPro.Cfg_allowDeleteOwnAccount_Hdr.JsEncode() %>',
          content: '<%= Resources.GalleryServerPro.Cfg_allowDeleteOwnAccount_Bdy.JsEncode() %>'
        });
