...
namespace GalleryServerPro.Web.Pages.Admin
{
	...
	public partial class backuprestore : Pages.AdminPage
	{
		...
		private void ActivateFirstTab()
		{
			...
			this.Page.ClientScript.RegisterStartupScript(this.GetType(), String.Concat(this.cid, "_brScript"), script, true);
		}
		...
		private void ConfigureControlsEveryPageLoad()
		{
			...
			// Don't disable backup/restore functionality based on product key. User should always be able to make a backup,
