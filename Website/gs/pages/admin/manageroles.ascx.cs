...
namespace GalleryServerPro.Web.Pages.Admin
{
	...
	public partial class manageroles : Pages.AdminPage
	{
		...
		protected string GetPermissionTreeviewData()
		{
			...
			nodeSiteAdmin.Text = Resources.GalleryServerPro.Admin_Manage_Roles_SiteAdmin_Text;
			...
			nodeGalleryAdmin.Text = Resources.GalleryServerPro.Admin_Manage_Roles_GalleryAdmin_Text;
			...
			foreach (string perm in perms)
			{
				...
				n.Text = Resources.GalleryServerPro.ResourceManager.GetString(String.Concat(resourcePrefix, perm, headerSuffix));
			...
			nodeWtrmk.Text = Resources.GalleryServerPro.Admin_Manage_Roles_HideWatermark_Text;
		...
		protected string GetRoleNames()
		{
			...
			roles.Add(new Role { Name = Resources.GalleryServerPro.Admin_Manage_Roles_Create_Role_Lbl, IsNew = true });
		...
		{
			AdminPageTitle = Resources.GalleryServerPro.Admin_Manage_Roles_Page_Header;
		}
