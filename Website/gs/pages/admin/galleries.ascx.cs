...
namespace GalleryServerPro.Web.Pages.Admin
{
	...
	public partial class galleries : AdminPage
	{
		...
		private void DataBindDeleteButtonInGalleriesGridRow(GridViewRowEventArgs e)
		{
			...
			if (gallery.GalleryId != GalleryId)
			{
				string msg = String.Format(CultureInfo.InvariantCulture, Resources.GalleryServerPro.Admin_Gallery_Settings_Delete_Gallery_Confirm_Text, gallery.Description.JsEncode());
					...
					ClientMessage = new ClientMessageOptions
														{
															...
															Message = Resources.GalleryServerPro.Admin_Gallery_Settings_Gallery_Description_Required,
			...
			foreach (DictionaryEntry entry in e.InputParameters)
			{
				...
				if (gallery.GalleryId == GalleryId)
				{
					...
					ClientMessage = new ClientMessageOptions
														{
															Title = Resources.GalleryServerPro.Validation_Summary_Text,
															Message = String.Format(CultureInfo.InvariantCulture, Resources.GalleryServerPro.Admin_Gallery_Settings_Cannot_Delete_Current_Gallery_Text, gallery.Description.JsEncode()),
															Style = MessageStyle.Error
														};
				}
			}
		...
		{
			PageTitle = Resources.GalleryServerPro.Admin_Gallery_Manager_Page_Header;
		}
		...
		private void DetectAndSaveChangedGallery()
		{
			...
			else
			{
				ClientMessage = new ClientMessageOptions
													{
														Title = Resources.GalleryServerPro.Validation_Summary_Text,
														Message = Resources.GalleryServerPro.Admin_Gallery_Settings_Different_Gallery_Not_Selected_Text,
														Style = MessageStyle.Info
													};
			}
		}
		...
		private void CheckForMessages()
		{
			if (ClientMessage != null && ClientMessage.MessageId == MessageType.GallerySuccessfullyChanged)
			{
				ClientMessage = new ClientMessageOptions
													{
														Title = Resources.GalleryServerPro.Admin_Save_Success_Hdr,
														Message = Resources.GalleryServerPro.Admin_Gallery_Settings_Gallery_Changed_Text,
														Style = MessageStyle.Success
													};
			}
		}
