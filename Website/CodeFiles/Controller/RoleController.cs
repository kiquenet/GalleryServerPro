...
namespace GalleryServerPro.Web.Controller
{
	...
	public static class RoleController
	{
		...
		public static void Save(Entity.Role role)
		{
			...
			{
				if (r != null)
					throw new InvalidGalleryServerRoleException(Resources.GalleryServerPro.Admin_Manage_Roles_Cannot_Create_Role_Already_Exists_Msg);
		...
		public static IGalleryServerRoleCollection GetGalleryServerRolesForUser(string userName)
		{
			...
			if (rolesCache == null)
			{
				...
				rolesCache = (ConcurrentDictionary<string, IGalleryServerRoleCollection>)HelperFunctions.GetCache(CacheItem.GalleryServerRoles);
				if (rolesCache == null)
				{
		...
		public static string ValidateSysAdminRole()
		{
			...
			var sysAdminRoleName = Resources.GalleryServerPro.Site_Sys_Admin_Role_Name;
		...
		public static void RemoveRolesFromCache()
		{
			...
			if ((rolesCache != null) && (HttpContext.Current.Session != null))
			{
				...
				rolesCache.TryRemove(GetCacheKeyNameForRoles(Utils.UserName), out roles);
			}
		}
