...
namespace GalleryServerPro.Web.Entity
{
  ...
  public class TreeNode
  {
    ...
    public string CssClasses
    {
      ...
      private set { throw new NotImplementedException("Setter not implemented for property 'CssClasses' in class GalleryServerPro.Web.Entity.TreeNode. Use method AddCssClass or RemoveCssClass instead."); }
    }
