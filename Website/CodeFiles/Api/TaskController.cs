...
{
	/// <summary>
	/// Contains Web API methods for invoking actions in Gallery Server Pro.
	/// </summary>
	public class TaskController : ApiController
	{
		...
		/// defined in <see cref="GalleryServerPro.Web.HttpModule.GspHttpApplication" /> requires that it have this name.</param>
		...
		{
			IAlbum album = AlbumController.LoadAlbumInstance(syncOptions.AlbumIdToSynchronize, true, true, true);
		...
		private static void StartRemoteSyncForAllGalleries(SyncOptions syncOptions, string password)
		{
			...
			{
				var rootAlbum = Factory.LoadRootAlbumInstance(gallery.GalleryId, false, false);
