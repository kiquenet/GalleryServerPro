...
namespace GalleryServerPro.Web.Api
{
	...
	public class AlbumSyndicationFeedFormatter : MediaTypeFormatter
	{
		...
		public override Task WriteToStreamAsync(Type type, object value, Stream writeStream, HttpContent content, TransportContext transportContext)
		{
			...
			return Task.Factory.StartNew(() => BuildSyndicationFeed(album, writeStream, content.Headers.ContentType.MediaType, options));
		}
	...
	public class AlbumSyndicationFeedBuilder
	{
		...
		/// <see cref="IAlbum.Sequence" /> property.
		/// </summary>
		private IEnumerable<IGalleryObject> MediaObjects
		{
			get
			{
				...
				{
					return Album.GetChildGalleryObjects(GalleryObjectType.All, !Options.IsAuthenticated).ToSortedList(Album.FeedFormatterOptions.SortByMetaName, Album.FeedFormatterOptions.SortAscending, Album.GalleryId);
				}
				else
				{
					return Album.GetChildGalleryObjects(GalleryObjectType.All, !Options.IsAuthenticated).ToSortedList();
				}
			}
		}
