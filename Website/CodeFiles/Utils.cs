...
namespace GalleryServerPro.Web
{
	...
	public static class Utils
	{
		...
		/// if present; otherwise it defaults to "gs". Examples: "gs", "GalleryServerPro\resources"
		/// </summary>
		...
		/// </summary>
		/// <param name="resource">A path relative to the skin directory containing the Gallery Server Pro resource files (ex: images/info.gif).
		...
		public static IEnumerable<KeyValuePair<string, string>> GetEnumList(Type enumeration)
		{
			...
			foreach (string enumName in enumNames)
			{
				...
				string resDesc = Resources.GalleryServerPro.ResourceManager.GetString(resourceKey, CultureInfo.CurrentCulture);
		...
		//	return Resources.GalleryServerPro.ResourceManager.GetString(resourceKey, CultureInfo.CurrentCulture) ?? value.ToString();
		//}
