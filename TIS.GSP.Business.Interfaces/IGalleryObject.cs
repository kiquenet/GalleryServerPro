...
namespace GalleryServerPro.Business.Interfaces
{
	...
	public interface IGalleryObject
	{
		...
		/// <summary>
		/// Gets or sets the amount of rotation to be applied to this gallery object when it is saved. Applies only to image and video objects;
		...
		MediaObjectRotation CalculateNeededRotation();
