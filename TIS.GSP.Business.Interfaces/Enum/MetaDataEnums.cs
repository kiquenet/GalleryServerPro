...
namespace GalleryServerPro.Business.Metadata
{
	...
	public enum FlashMode : ushort
	{
		...
		[Description("Flash fired, auto mode, returnLightDetected")]
		...
		[Description("Flash fired, red-eye reduction mode, returnLightDetected")]
		...
		[Description("Flash fired, compulsory flash mode, red-eye reduction mode, returnLightDetected")]
	...
	public enum ExtractedValueType
	{
		...
		String,
		///<summary>Specifies that the value is an instance of GalleryServerPro.Business.Fraction.</summary>
		Fraction,
		///<summary>Specifies that the value is an instance of GalleryServerPro.Business.Fraction[].</summary>
		FractionArray
	}
