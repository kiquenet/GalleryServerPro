...
namespace GalleryServerPro.Business
{
	...
	/// <summary>
	/// Specifies a particular item within an application event (<see cref="GalleryServerPro.Business.Interfaces.IEvent"/>).
	/// </summary>
	...
	/// <summary>
	/// Identifies the amount of rotation applied to a media object.
	/// </summary>
	public enum MediaObjectRotation
	{
		/// <summary>
